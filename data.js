...
const UNITS = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: "Why did immigrants come to the U.S.?",
        a: "Many immigrants came to the United States because of hardships and political problems in their home countries.",
        correct: "Because of hardships and problems at home",
        wrong: ["To escape the Gold Rush", "To join the Confederate army", "Because the U.S. had no laws"],
      },
      {
        q: "How did the cotton gin affect slavery?",
        a: "The cotton gin increased the demand for enslaved workers on plantations.",
        correct: "It increased the demand for enslaved workers",
        wrong: ["It ended slavery quickly", "It had no effect on slavery", "It freed enslaved workers"],
      },
      {
        q: "How did geography help Southern farming?",
        a: "The warm climate and fertile land were good for growing cash crops.",
        correct: "Warm climate and fertile land for cash crops",
        wrong: ["Cold winters and rocky soil", "Tall mountains and deserts", "Frozen rivers"],
      },
      {
        q: "How did Frederick Douglass fight slavery?",
        a: "Frederick Douglass fought slavery by giving speeches and writing against slavery.",
        correct: "By giving speeches and writing against slavery",
        wrong: ["By leading an army", "By becoming president", "By building railroads"],
      },
      {
        q: "Why were railroads important?",
        a: "Railroads were important because they allowed goods and people to travel more quickly.",
        correct: "They let goods and people travel faster",
        wrong: ["They made farming illegal", "They replaced all rivers", "They only carried mail"],
      },
      {
        q: "What challenges did immigrants face?",
        a: "Immigrants faced challenges such as discrimination, crowded housing, and low-paying jobs.",
        correct: "Discrimination, crowded housing, and low pay",
        wrong: ["Too much free land", "No work to do at all", "Free mansions for everyone"],
      },
    ],
  },
  {
    id: "unit8",
    title: "The Union Challenged",
    subtitle: "Unit 8",
    emoji: "⚔️", // crossed swords (Civil War)
    color: "#d65a5a",
    questions: [
      {
        q: "Why did Missouri joining the Union create conflict?",
        a: "Missouri joining the Union created conflict because it threatened the balance between free and slave states.",
        correct: "It threatened the balance of free and slave states",
        wrong: ["It had too many people", "It was too far west", "It refused to pay taxes"],
      },
      {
        q: "What effect did Uncle Tom's Cabin have?",
        a: "Uncle Tom's Cabin caused many Americans to become more opposed to slavery.",
        correct: "More Americans became opposed to slavery",
        wrong: ["It started the Gold Rush", "It ended the Civil War", "It made slavery legal"],
      },
      {
        q: "What was created in 1861 by Southern states?",
        a: "In 1861, several Southern states created the Confederate States of America.",
        correct: "The Confederate States of America",
        wrong: ["The United Nations", "The Bill of Rights", "The Louisiana Territory"],
      },
      {
        q: "What advantage did the North have?",
        a: "The North had more factories and resources at the beginning of the Civil War.",
        correct: "More factories and resources",
        wrong: ["More cotton farms", "A larger king", "Warmer weather"],
      },
      {
        q: "Why was Gettysburg a turning point?",
        a: "Gettysburg was a turning point because Confederate forces suffered major losses and stopped invading the North.",
        correct: "The South suffered major losses and stopped invading",
        wrong: ["The North surrendered", "It started the war", "Slavery ended that day"],
      },
      {
        q: "Why was Vicksburg important?",
        a: "Vicksburg was important because the Union gained control of the Mississippi River.",
        correct: "The Union gained control of the Mississippi River",
        wrong: ["It was the capital of the South", "Gold was found there", "It ended Reconstruction"],
      },
      {
        q: "What happened during Reconstruction?",
        a: "During Reconstruction, Southern states were required to create new constitutions and rebuild their governments.",
        correct: "The South rebuilt governments and wrote new constitutions",
        wrong: ["The South left America forever", "Slavery was made legal again", "Only the North was rebuilt"],
      },
      {
        q: "Why were Jim Crow laws created?",
        a: "Jim Crow laws were created to separate racial groups in public life.",
        correct: "To separate racial groups in public life",
        wrong: ["To give everyone equal rights", "To end the Civil War", "To build railroads"],
      },
      {
        q: "How did African Americans improve their lives after the war?",
        a: "African Americans improved their lives by building churches, schools, and communities together.",
        correct: "By building churches, schools, and communities",
        wrong: ["By leaving the country", "By joining the Confederacy", "By stopping all work"],
      },
      {
        q: "Why did Congress pass the Military Reconstruction Act?",
        a: "Congress passed the Military Reconstruction Act because of disagreements with President Andrew Johnson.",
        correct: "Disagreements with President Andrew Johnson",
        wrong: ["To start the Civil War", "To free Texas", "To lower taxes"],
      },
      {
        q: "Why did slavery create tensions?",
        a: "Slavery created tensions because the North and South disagreed about slavery's expansion into new territories.",
        correct: "The North and South disagreed about spreading slavery",
        wrong: ["Everyone agreed about slavery", "It was about tea taxes", "It was only about railroads"],
      },
      {
        q: "Why was the North better prepared for war?",
        a: "The North was better prepared because it had more factories, railroads, and supplies.",
        correct: "It had more factories, railroads, and supplies",
        wrong: ["It had more cotton", "It had a king", "It had warmer weather"],
      },
      {
        q: "How did Reconstruction rebuild the South?",
        a: "Reconstruction attempted to rebuild the South by rebuilding governments and protecting the rights of formerly enslaved people.",
        correct: "By rebuilding governments and protecting freed people's rights",
        wrong: ["By bringing back slavery", "By moving everyone north", "By banning schools"],
      },
      {
        q: "What effect did Jim Crow laws have?",
        a: "Jim Crow laws caused segregation and discrimination against African Americans.",
        correct: "Segregation and discrimination against African Americans",
        wrong: ["Equal rights for all", "The end of the war", "Free land for everyone"],
      },
    ],
  },
];
